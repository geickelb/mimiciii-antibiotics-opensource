...
date= '10102019' #will be used to name files generated
...
final_pt_df= pd.read_csv(Path(str(repository_path)+ '/data/{}_final_pt_df.csv'.format(date))) #final patient list generated by 02-cohort
...
final_pt_df_v= pd.read_csv(Path(str(repository_path)+ '/data/{}_final_pt_df_v.csv'.format(date))) 
