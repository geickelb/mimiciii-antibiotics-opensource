  ...
  , max(
    ...
    , max(
      case
        ...
        when itemid = 467 and value in --### WHAT IS 467? 8/14/18
        (
          'Cannula', -- 278252 observations
          'Nasal Cannula', -- 248299 observations
          'None', -- 95498 observations.  --???potentially means not otherwise specified????? investigate this! email mimic? if this is truely nothing then flow of L/min should be ~0. 
