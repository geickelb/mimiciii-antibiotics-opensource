...
(
    ...
    --, max(case when itemid in (30042,30306) then amountuom else null end) as amount_uom  --these two lines provide units
	--, max(case when itemid in (30042,30306) then rateuom else null end) as rate_uom
